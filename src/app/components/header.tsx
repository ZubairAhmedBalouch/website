    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
        <div className="flex flex-col items-start">
            <div className="lg:max-w-lg lg:p-10">
                ...
                <p className="mt-3 text-lg text-gray-600 dark:text-gray-400 lg:text-3xl">
                ...
                <button className=" px-5 py-2 mt-6 text-sm tracking-wider text-white uppercase transition-colors duration-300 transform bg-blue-600 rounded-lg lg:w-auto hover:bg-blue-500 focus:outline-none focus:bg-blue-500">
                    Shop Now
                </button>
            </div>
        </div>
